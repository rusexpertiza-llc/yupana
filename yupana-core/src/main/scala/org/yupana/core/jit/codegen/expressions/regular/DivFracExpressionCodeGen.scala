...
trait DivFracExpressionCodeGen extends ExpressionCodeGen[DivFracExpr[_]] {
...
object DivFracExpressionCodeGen {
  def apply(expr: DivFracExpr[_]): DivFracExpressionCodeGen = {
    new DivFracExpressionCodeGen() {
      override def expression: DivFracExpr[_] = expr
    }
  }
}
