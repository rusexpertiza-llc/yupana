...
object FunctionRegistry {
  ...
  private val unaryFunctions: List[FunctionDesc] = List(
    ...
    uTyped("year", TruncYearExpr.apply),
    uTyped("trunc_year", TruncYearExpr.apply),
    uTyped("quarter", TruncQuarterExpr.apply),
    uTyped("trunc_quarter", TruncQuarterExpr.apply),
    uTyped("month", TruncMonthExpr.apply),
    uTyped("trunc_month", TruncMonthExpr.apply),
    uTyped("week", TruncWeekExpr.apply),
    uTyped("trunc_week", TruncWeekExpr.apply),
    uTyped("day", TruncDayExpr.apply),
    uTyped("trunc_day", TruncDayExpr.apply),
    uTyped("hour", TruncHourExpr.apply),
    uTyped("trunc_hour", TruncHourExpr.apply),
    uTyped("minute", TruncMinuteExpr.apply),
    uTyped("trunc_minute", TruncMinuteExpr.apply),
    ...
    uTyped("extract_minute", ExtractMinuteExpr.apply),
    uTyped("extract_second", ExtractSecondExpr.apply),
    uTyped("length", LengthExpr.apply),
    uAny("is_null", e => IsNullExpr(e)),
    uAny("is_not_null", e => IsNotNullExpr(e)),
    uTyped("not", NotExpr.apply),
    uTyped("tokens", TokensExpr.apply),
    uTyped("split", SplitExpr.apply),
    uTyped("lower", LowerExpr.apply),
    uTyped("upper", UpperExpr.apply),
    uArray(
      "array_to_string",
    ...
    uTyped("tokens", ArrayTokensExpr.apply),
    // SPECIAL
  ...
  private val binaryFunctions: List[Function2Desc] = List(
    ...
    biTyped("+", ConcatExpr.apply),
    biTyped("-", TimeMinusExpr.apply),
    biTyped("-", TimeMinusPeriodExpr.apply),
    biTyped("+", TimePlusPeriodExpr.apply),
    biTyped("+", PeriodPlusPeriodExpr.apply),
    biArrayAndElem(
      "contains",
