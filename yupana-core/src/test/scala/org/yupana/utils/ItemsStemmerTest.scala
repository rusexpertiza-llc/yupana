...
class ItemsStemmerTest extends FlatSpec with Matchers {
  "Stemmer" should "split numbers and words" in {
    ...
    ItemsStemmer.words("трк 1 (atum-92-к5) 1.256281 x 39.80") should contain theSameElementsAs List(
      "трк",
      "1",
      "atum",
      "92",
  ...
  it should "preserve ai" in {
    ...
    ItemsStemmer.words("аи-95аи-95-к5") should contain theSameElementsAs List(
      "аи",
      "95а",
      "95",
      "аи",
  ...
  it should "preserve ai with english 'a' and russian 'и' letters" in {
    ...
    ItemsStemmer.words("aи-95aи-95-к5") should contain theSameElementsAs List(
      "aи",
      "95a",
      "95",
      "aи",
  ...
  it should "preserve letter slash letter abbreviations" in {
    ...
    ItemsStemmer.words("\"дт фора/-32, n 1:00000\"") should contain theSameElementsAs List(
      "дт",
      "фор",
      "32",
      "n",
    ...
    ItemsStemmer.words("трk 1:аи-95пульсар-k5 трз0") should contain theSameElementsAs List(
      "трk",
      "1",
      "аи",
      "95пульсар",
