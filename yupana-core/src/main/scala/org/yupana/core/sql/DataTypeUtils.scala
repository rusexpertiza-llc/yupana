...
object DataTypeUtils {
  ...
  private val autoConverters: Map[(String, String), ToTypeConverter[_, _]] = Map(
    entry[Double, BigDecimal](Double2BigDecimalExpr.apply),
    entry[Long, BigDecimal](Long2BigDecimalExpr.apply),
    entry[Long, Double](Long2DoubleExpr.apply),
    entry[Int, Long](Int2LongExpr.apply),
    entry[Int, BigDecimal](Int2BigDecimalExpr.apply),
    entry[Int, Double](Int2DoubleExpr.apply),
    entry[Short, Int](Short2IntExpr.apply),
    entry[Short, Long](Short2LongExpr.apply),
    entry[Short, BigDecimal](Short2BigDecimalExpr.apply),
    entry[Short, Double](Short2DoubleExpr.apply),
    entry[Byte, Short](Byte2ShortExpr.apply),
    entry[Byte, Int](Byte2IntExpr.apply),
    entry[Byte, Long](Byte2LongExpr.apply),
    entry[Byte, BigDecimal](Byte2BigDecimalExpr.apply),
    entry[Byte, Double](Byte2DoubleExpr.apply)
  )
