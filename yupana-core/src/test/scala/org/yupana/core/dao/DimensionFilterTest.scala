...
class DimensionFilterTest extends FlatSpec with Matchers {
  ...
  "DimensionFilter" should "combine NoResult with other filters" in {
    ...
    ((DimensionFilter(Dimension("tag"), Set(3)) and DimensionFilter(Dimension("tag2"), Set(1,2))) or NoResult()).mat shouldEqual Map("tag" -> Set(3), "tag2" -> Set(1,2))
  }
  ...
  it should "combine two filters collections using and and or merge strategies" in {
    (DimensionFilter(Dimension("a"), Set(1, 2, 3)) and DimensionFilter(Dimension("a"), Set(2, 3, 4))).mat shouldEqual Map("a" -> Set(2, 3))
    DimensionFilter(Dimension("a"), Set(1, 2)) and DimensionFilter(Dimension("a"), Set(3, 4)) shouldEqual NoResult()

    (DimensionFilter(Dimension("a"), Set(1, 2)) and DimensionFilter(Dimension("b"), Set(3, 4))).mat shouldEqual Map("a" -> Set(1,2), "b" -> Set(3, 4))
    (DimensionFilter(Dimension("a"), Set(1, 2)) and DimensionFilter(Dimension("b"), Set(2, 3)) and DimensionFilter(Dimension("b"), Set(3, 4))).mat shouldEqual Map("a"-> Set(1,2), "b" -> Set(3))

    DimensionFilter(Dimension("a"), Set(1, 2)) and DimensionFilter(Dimension("b"), Set(2)) and DimensionFilter(Dimension("b"), Set(3, 4)) shouldEqual NoResult()

    (DimensionFilter(Dimension("a"), Set(1, 2, 3)) or DimensionFilter(Dimension("a"), Set(2, 3, 4))).mat shouldEqual Map("a" -> Set(1, 2, 3, 4))
    (DimensionFilter(Dimension("a"), Set(1, 2)) or DimensionFilter(Dimension("a"), Set(3, 4))).mat shouldEqual Map("a"-> Set(1, 2, 3, 4))

    (DimensionFilter(Dimension("a"), Set(1, 2)) or DimensionFilter(Dimension("b"), Set(3, 4))).mat shouldEqual Map("a" -> Set(1, 2), "b" -> Set(3, 4))
    (DimensionFilter(Dimension("a"), Set(1, 2)) and DimensionFilter(Dimension("b"), Set(2, 3)) or DimensionFilter(Dimension("b"), Set(3, 4))).mat shouldEqual Map("a" -> Set(1, 2), "b" -> Set(2, 3, 4))

    (DimensionFilter(Dimension("a"), Set(1, 2)) and DimensionFilter(Dimension("b"), Set(2)) or DimensionFilter(Dimension("b"), Set(3, 4))).mat shouldEqual Map("a" -> Set(1, 2), "b" -> Set(2, 3, 4))
  }
  ...
  it should "exclude from filters collection" in {
    ...
    (filters exclude (DimensionFilter(Dimension("a"), Set(1, 3)) and DimensionFilter(Dimension("b"), Set(4)))).mat shouldEqual Map("a" -> Set(2), "b" -> Set(3))
