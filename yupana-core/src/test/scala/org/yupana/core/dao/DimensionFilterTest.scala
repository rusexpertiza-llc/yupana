...
class DimensionFilterTest extends FlatSpec with Matchers {
  ...
  "DimensionFilter" should "combine NoResult with other filters" in {
    ...
    NoResult() or FiltersCollection(Map(Dimension("tag") -> Set(1))) shouldEqual FiltersCollection(Map(Dimension("tag") -> Set(1)))
    FiltersCollection(Map(Dimension("tag") -> Set(3), Dimension("tag2") -> Set(1,2))) or NoResult() shouldEqual FiltersCollection(Map(Dimension("tag") -> Set(3), Dimension("tag2") -> Set(1,2)))
  }
  ...
  it should "combine two filters collections using and and or merge strategies" in {
    FiltersCollection(Map(Dimension("a") -> Set(1, 2, 3))) and FiltersCollection(Map(Dimension("a") -> Set(2, 3, 4))) shouldEqual FiltersCollection(Map(Dimension("a") -> Set(2, 3)))
    FiltersCollection(Map(Dimension("a") -> Set(1, 2))) and FiltersCollection(Map(Dimension("a") -> Set(3, 4))) shouldEqual NoResult()

    FiltersCollection(Map(Dimension("a") -> Set(1, 2))) and FiltersCollection(Map(Dimension("b") -> Set(3, 4))) shouldEqual FiltersCollection(Map(Dimension("a") -> Set(1,2), Dimension("b") -> Set(3, 4)))
    FiltersCollection(Map(Dimension("a") -> Set(1, 2), Dimension("b") -> Set(2, 3))) and FiltersCollection(Map(Dimension("b") -> Set(3, 4))) shouldEqual FiltersCollection(Map(Dimension("a") -> Set(1,2), Dimension("b") -> Set(3)))

    FiltersCollection(Map(Dimension("a") -> Set(1, 2), Dimension("b") -> Set(2))) and FiltersCollection(Map(Dimension("b") -> Set(3, 4))) shouldEqual NoResult()

    FiltersCollection(Map(Dimension("a") -> Set(1, 2, 3))) or FiltersCollection(Map(Dimension("a") -> Set(2, 3, 4))) shouldEqual FiltersCollection(Map(Dimension("a") -> Set(1, 2, 3, 4)))
    FiltersCollection(Map(Dimension("a") -> Set(1, 2))) or FiltersCollection(Map(Dimension("a") -> Set(3, 4))) shouldEqual FiltersCollection(Map(Dimension("a") -> Set(1, 2, 3, 4)))

    FiltersCollection(Map(Dimension("a") -> Set(1, 2))) or FiltersCollection(Map(Dimension("b") -> Set(3, 4))) shouldEqual FiltersCollection(Map(Dimension("a") -> Set(1, 2), Dimension("b") -> Set(3, 4)))
    FiltersCollection(Map(Dimension("a") -> Set(1, 2), Dimension("b") -> Set(2, 3))) or FiltersCollection(Map(Dimension("b") -> Set(3, 4))) shouldEqual FiltersCollection(Map(Dimension("a") -> Set(1,2), Dimension("b") -> Set(2, 3, 4)))

    FiltersCollection(Map(Dimension("a") -> Set(1, 2), Dimension("b") -> Set(2))) or FiltersCollection(Map(Dimension("b") -> Set(3, 4))) shouldEqual FiltersCollection(Map(Dimension("a") -> Set(1, 2), Dimension("b") -> Set(2, 3, 4)))
  }
  ...
  it should "exclude from filters collection" in {
    ...
    filters exclude FiltersCollection(Map(Dimension("a") -> Set(1, 3), Dimension("b") -> Set(4))) shouldEqual FiltersCollection(Map(Dimension("a") -> Set(2), Dimension("b") -> Set(3)))
