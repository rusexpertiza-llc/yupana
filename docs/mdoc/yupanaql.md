...
## Функции
[ItemsInvertedIndex](#items-inverted-index)
...
| [hll_count](#func_hcount)      | агрегация     | число, строка           |      Long       | Апроксимированное количество уникальных значений                                                                   |
...
- Не игнорирует строки, в которых поле принимает значение NULL
...
Ограничения и особенности:
- Опеделена для целочисленных типов данных и строк
- Не игнорирует строки, в которых поле принимает значение NULL
